        ...
        <div className="relative">
          {token ? (
            ...
            <>
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} className="w-6 h-6 transition-colors duration-200 stroke-green-400 group-hover:stroke-green-300" stroke="currentColor">
